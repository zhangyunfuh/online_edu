    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, max_length=256, null=True, upload_to='user/', verbose_name='用户头像')),
                ...
                ('address', models.CharField(blank=True, max_length=256, null=True, verbose_name='用户地址')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('image', models.ImageField(max_length=256, upload_to='banner/', verbose_name='轮播图片')),
